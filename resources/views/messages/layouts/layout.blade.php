...
<head>
    ...
    <link rel="stylesheet"
          href="http://zafree.github.io/bootaide/bower_components/fontface-source-sans-pro/css/source-sans-pro.min.css"/>
    <link rel="stylesheet"
          href="http://zafree.github.io/bootaide/bower_components/owl-carousel2/dist/assets/owl.carousel.min.css"/>
    <link rel="stylesheet"
          href="http://zafree.github.io/bootaide/bower_components/owl-carousel2/dist/assets/owl.theme.default.min.css"/>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href class="dropdown-toggle clear" data-toggle="dropdown">
								...
								</span> <span class="hidden-sm hidden-md"><i
                        ...
                        <div class="btn-group pull-right">
                            ...
                            @if(isset($id))
                                <ul class="dropdown-menu">
                                    <li><a href="{{url('laravel-talk/example/conversation/delete/'. @$id)}}">Delete
                                            Conversation</a></li>
                                </ul>
                            @endif
                        </div>
